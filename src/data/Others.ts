...
export const story: string[] = [
    ...
    'After a painful lot of part-time jobs, as a high schooler I had been searching for money wherever I could (from KFC to a warehouse) I finally after graduating from High school found my first IT-related job (if you could say that) as a tester of mobile applications in Škoda a.s.',
...
export const socials: SocialsType[] = [
    {
        name: 'linkedin',
        link: 'https://www.linkedin.com/in/samuel-vitek'
    },
    {
        name: 'github',
        link: 'https://github.com/SamuelVitek'
    },
    {
        name: 'kaggle',
